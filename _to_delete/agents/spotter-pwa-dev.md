...
2. Load the project skills `spotter-ui` (layout, sizing, slider mapping, status UX, PWA setup) and `race-relay-protocol` (message shapes — import from `packages/protocol`, never redefine).
