...
<!-- GENERATED from agents/roles/g2-glasses-dev.md by scripts/sync-agents.mjs — edit the role file, not this one. -->
...
Project skills listed above are preloaded. For SDK mechanics use the official plugin skills: `/sdk-reference`, `/glasses-ui`, `/handle-input`, `/background-state`, `/font-measurement`. Read `AGENTS.md` for build/test commands and the loop protocol.
